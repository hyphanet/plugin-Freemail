#@+leo
#@+node:0::@file pyweb/Cookie.py
#@+body
#@@language python
#@<< Cookie declarations >>
#@+node:1::<< Cookie declarations >>
#@+body
#!/usr/bin/env python
#
...
####
# 
# $Id: Cookie.py,v 2.30 2000/08/26 01:42:49 timo Exp $
...
#@+others
#@+node:2::class CookieError
#@+body
class CookieError(Exception):
	
    #@<< class CookieError declarations >>
    #@+node:1::<< class CookieError declarations >>
    #@+body
    pass
...
class Morsel(UserDict):
    ...
    #@<< class Morsel declarations >>
    #@+node:1::<< class Morsel declarations >>
    #@+body
...
class BaseCookie(UserDict):
    ...
    #@<< class BaseCookie declarations >>
    #@+node:1::<< class BaseCookie declarations >>
    #@+body
...
class SimpleCookie(BaseCookie):
    ...
    #@<< class SimpleCookie declarations >>
    #@+node:1::<< class SimpleCookie declarations >>
    #@+body
    """SimpleCookie
...
#@-body
#@-node:9::class SimpleCookie
#@+node:10::class SerialCookie
#@+body
# end SimpleCookie

class SerialCookie(BaseCookie):
	
    #@<< class SerialCookie declarations >>
    #@+node:1::<< class SerialCookie declarations >>
    #@+body
    """SerialCookie
...
#@-body
#@-node:10::class SerialCookie
#@+node:11::class SmartCookie
#@+body
# end SerialCookie

class SmartCookie(BaseCookie):
	
    #@<< class SmartCookie declarations >>
    #@+node:1::<< class SmartCookie declarations >>
    #@+body
    """SmartCookie
