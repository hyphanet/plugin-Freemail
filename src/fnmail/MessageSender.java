...
public class MessageSender implements Runnable {
	...
	public static final String NIM_KEY_PREFIX = "KSK@fnmail-nim-";
	...
	private synchronized void copyToOutbox(File src, File outbox, String to) throws IOException {
		File tempfile = File.createTempFile("fmail-msg-tmp", null, FNMail.getTempDir());
	...
	private boolean slotinsert(File data, String basekey) {
		HighLevelFCPClient cli = new HighLevelFCPClient(FNMail.getFCPConnection());
