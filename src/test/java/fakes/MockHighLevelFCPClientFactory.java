/*
 * MockHighLevelFCPClientFactory.java
...
public final class MockHighLevelFCPClientFactory extends HighLevelFCPClientFactory {
	private final HighLevelFCPClient fcpClient;

	public MockHighLevelFCPClientFactory(HighLevelFCPClient fcpClient) {
		this.fcpClient = fcpClient;
	}

	@Override
	public HighLevelFCPClient newInstance() {
		Logger.debug(this, "newInstance()");
		return fcpClient;
	}
}
