/*
 * IMAPStateCheckAuthenticatedTest.java
...
public class IMAPStateCheckAuthenticatedTest extends IMAPTestWithMessages {
	@Parameters
	...
	public IMAPStateCheckAuthenticatedTest(String command) {
